...
import mysql.cnxector 

cnx_db01 = mysql.cnxector.cnxect(host=db01_host, user=db01_user, password=db01_password)
db01 = cnx_db01.cursor()
cnx_db02 = mysql.cnxector.cnxect(host=db02_host, user=db02_user, password=db02_password)
